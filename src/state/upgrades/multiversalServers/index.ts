...
const multiversalServersUpgrades: Upgrade[] = [
    {
    ...
    },
    {
        ...
        requirementsToBeListable: {
            incrementorUnits: {
                multiversalServers: 300
            }
        }
    }
]

export default multiversalServersUpgrades 