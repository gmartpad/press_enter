...
const omniscientOraclesUpgrades: Upgrade[] = [
    {
    ...
    },
    {
        ...
        requirementsToBeListable: {
            incrementorUnits: {
                omniscientOracles: 300
            }
        }
    }
]

export default omniscientOraclesUpgrades 