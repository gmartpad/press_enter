...
const matrixArchitectsUpgrades: Upgrade[] = [
    {
    ...
    },
    {
        ...
        requirementsToBeListable: {
            incrementorUnits: {
                matrixArchitects: 300
            }
        }
    }
]

export default matrixArchitectsUpgrades 