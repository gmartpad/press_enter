...
const infinityProcessorsUpgrades: Upgrade[] = [
    {
    ...
    },
    {
        ...
        requirementsToBeListable: {
            incrementorUnits: {
                infinityProcessors: 300
            }
        }
    }
]

export default infinityProcessorsUpgrades 